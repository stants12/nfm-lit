...
public class Control {
    ...
    // NFM1 AI (aids)
    public void preform_1(Madness madness, ContO conto, CheckPoints checkpoints, Trackers trackers, int ncars)
    {
        left = false;
        right = false;
        up = false;
        ...
        if(!madness.dest)
        {
            if(madness.mtouch)
            {
                if(stcnt > statusque)
                {
                    ...
                    saftey = (int)((double)((98F - madness.power) / 2.0F) * ((double)(Medium.random() / 2.0F) + 0.5D));
                    if(saftey > 20)
                    {
                        saftey = 20;
                    }
                    ...
                    mustland = f + (float)((double)(Medium.random() / 2.0F) - 0.25D);
                    f = 1.0F;
                    if(checkpoints.stage == 1)
                    {
                        f = 5F;
                    ...
                    if(Medium.random() > madness.power / 100F)
                    {
                        usebounce = true;
                    } else
                    {
                    ...
                    if(Medium.random() > (float)madness.hitmag / (float)madness.stat.maxmag)
                    {
                        perfection = false;
                    } else
                    {
                    ...
                    if((100F * (float)madness.hitmag) / (float)madness.stat.maxmag > 60F)
                    {
                        perfection = true;
                    }
                    ...
                    if(attack == 0)
                    {
                        ...
                        do
                        {
                            if(i3 != madness.im && checkpoints.clear[i3] != -1)
                            {
                                ...
                                if(j5 < 85 + 15 * (Math.abs(checkpoints.clear[i3] - madness.clear) + 1) && Utility.py(conto.x / 100, checkpoints.opx[i3] / 100, conto.z / 100, checkpoints.opz[i3] / 100) < k5 && afta && madness.power > (float)k1)
                                {
                                ...
                                if(flag1 && j5 > 100 && Utility.py(conto.x / 100, checkpoints.opx[i3] / 100, conto.z / 100, checkpoints.opz[i3] / 100) < 300 && (double)Medium.random() > 0.59999999999999998D - (double)((float)checkpoints.pos[madness.im] / 10F))
                                {
                                    clrnce = 0;
                                    acuracy = 0;
                                }
                    ...
                    {
                        trfix = 0;
                        if((100F * (float)madness.hitmag) / (float)madness.stat.maxmag > 50F)
                        {
                            trfix = 1;
                        }
                        if(!flag2 && (100F * (float)madness.hitmag) / (float)madness.stat.maxmag > 80F)
                        {
                            trfix = 2;
                        }
                    } else
                    ...
                    if(!bulistc)
                    {
                        if(checkpoints.stage == 6 && madness.cn == 27)
                        {
                            bulistc = true;
                        }
                        if(checkpoints.stage == 9 && afta && (checkpoints.pos[madness.im] == 4 || checkpoints.pos[madness.im] == 3) && madness.cn != 29 && trfix != 0)
                        {
                            bulistc = true;
                        }
                    }
                ...
                if(attack == 0)
                {
                    ...
                    if(checkpoints.stage != 11 && (madness.missedcp == 0 || forget || trfix == 4 || checkpoints.stage == 10) && trfix != 0)
                    {
                        if(trfix == 2)
                        {
                            ...
                            {
                                if(Utility.py(conto.x / 100, checkpoints.x[fpnt[j4]] / 100, conto.z / 100, checkpoints.z[fpnt[j4]] / 100) < k2 || k2 == -10)
                                {
                                    k2 = Utility.py(conto.x / 100, checkpoints.x[fpnt[j4]] / 100, conto.z / 100, checkpoints.z[fpnt[j4]] / 100);
                                    j3 = j4;
                                }
                            }
                        ...
                        {
                            if(Utility.py(conto.x / 100, checkpoints.x[fpnt[l2]] / 100, conto.z / 100, checkpoints.z[fpnt[l2]] / 100) < 2000)
                            {
                                forget = false;
                                actwait = 0;
                                upwait = 0;
                    ...
                    if(turncnt > randtcnt)
                    {
                        ...
                        turncnt = 0;
                        randtcnt = (int)((float)acuracy * Medium.random());
                    } else
                    {
                        turncnt++;
                    }
                ...
                if(hold == 0)
                {
                    if(Math.abs(j - pan) < 180)
                    {
                        if(Math.abs(j - pan) > clrnce)
                        {
                            ...
                            if(Math.abs(j - pan) > 50 && madness.speed > (float)madness.stat.swits[0] && turntyp != 0)
                            {
                                if(turntyp == 1)
                                {
                                    down = true;
                    ...
                    if(Math.abs(j - pan) < 360 - clrnce)
                    {
                        ...
                        if(Math.abs(j - pan) < 310 && madness.speed > (float)madness.stat.swits[0] && turntyp != 0)
                        {
                            if(turntyp == 1)
                            {
                                down = true;
            ...
            } else
            {
                if(trickfase == 0)
                {
                    ...
                    if(k > 9 && Medium.random() > trickprf / 3F)
                    {
                        oxy = madness.pxy;
                        ozy = madness.pzy;
                        flycnt = 0;
                        ...
                        if(Medium.random() > Medium.random() || checkpoints.stage == 8)
                        {
                            if(Medium.random() > Medium.random())
                            {
                                uddirect = -1;
                            ...
                            udstart = (int)(10F * Medium.random() * trickprf);
                            if((double)Medium.random() > 0.84999999999999998D)
                            {
                                udswt = true;
                            }
                            if(Medium.random() > trickprf + 0.3F && checkpoints.stage != 8)
                            {
                                if(Medium.random() > Medium.random())
                                {
                                    lrdirect = -1;
